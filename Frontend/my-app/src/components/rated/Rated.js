...
export default function Rated({age}) {
    ...
    switch(age){
        case "0": return (
            <div className='RatedContainer'><img src={FSK0}></img></div>
           );break;
        case "6": return (
            <div className='RatedContainer'><img src={FSK6}></img></div>
           );break;
        case "12": return (
            <div className='RatedContainer'><img src={FSK12}></img></div>
           );break;           
        case "16": return (
            <div className='RatedContainer'><img src={FSK16}></img></div>
           );break;
        case "18": return (
            <div className='RatedContainer'><img src={FSK18}></img></div>
           );break;
